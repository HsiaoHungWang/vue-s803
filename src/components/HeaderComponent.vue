...
<template>
    <header class="p-3 text-bg-dark"> <div class="container"> <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start"> <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none"> <svg class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap"><use xlink:href="#bootstrap"></use></svg> </a> <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"> 
        <li><RouterLink :to="{name:'home'}" class="nav-link px-2 text-white" activeClass="active">首頁</RouterLink></li>
            
        <li>
            <RouterLink :to="{name:'about'}" class="nav-link px-2 text-white" activeClass="active">關於我們</RouterLink></li>
        ...
        <li><RouterLink :to="{name:'member', params:{id:1}}"  class="nav-link px-2 text-white"  activeClass="active">會員中心</RouterLink></li> 
         ...
         <li><RouterLink :to="{name:'tabs'}"  class="nav-link px-2 text-white"  activeClass="active">TabsView</RouterLink></li> 
          <li><RouterLink :to="{name:'spots'}"  class="nav-link px-2 text-white"  activeClass="active">台北市景點</RouterLink></li> 
